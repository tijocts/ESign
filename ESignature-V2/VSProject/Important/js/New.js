...
//canvas.fillText("Roopppppppaa", 425.2360876897134, 779.8690476190476);
...
$(document).bind('pagerendered', function (e) {
	...
	canvas.fillText("Rfdfdsgdfgdfghdfhfoopa", 425.2360876897134, 779.8690476190476, 20);
});
...
function renderizzaPlaceholder(currentPage, parametri) {
	...
	for (i = 0; i < parametri.length; i++) {
		...
		$("#parametriContainer").append('<div class="' + classStyle + '" data-id="-1" data-page="' + page + '" data-toggle="' + valore + '" data-valore="' + valore + '" data-x="' + x + '" data-y="' + y + '" style="transform: translate(' + x + 'px, ' + y + 'px); display:' + display + '">  <span class="circle"></span><img src="/Images/samjoseph.png" width="80px" height="32px"></img></div>');
	}
...
function renderizzaInPagina(parametri) {
	...
	for (i = 0; i < parametri.length; i++) {
		...
		$("#parametriContainer").append('<div class="' + classStyle + '" data-id="' + param.idParametroModulo + '" data-toggle="' + valore + '" data-valore="' + valore + '" data-x="' + x + '" data-y="' + y + '" style="transform: translate(' + x + 'px, ' + y + 'px);">  <span class="circle"></span><img src="/Images/samjoseph.png" width="80px" height="32px"/></div>');
	}
}
...
function showCoordinates() {
	...
	if (ControlList.length == 0 || ControlList.length == 0) {
		ControlsCount = 0;
		alert('Please drag Signature for Signing.');
	}
	else {
		ControlsCount = ControlList.length;
...
var element = document.getElementById('the-canvas');
