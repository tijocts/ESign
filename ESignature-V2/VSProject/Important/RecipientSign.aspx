<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RecipientSign.aspx.cs" Inherits="Important.RecipientSign" %>
    ...
    <body>
        ...
        <div style="text-align: right;">
            <asp:Button ID="btn" runat="server" Text="Send" ForeColor="Green" OnClick="btn_Click" OnClientClick="javascript:Validate();return true;" />
             <asp:Button ID="btndownload" runat="server" Text="Download" Visible="false" ForeColor="Green" OnClick="btndownload_Click" />
            <asp:Button ID="btnLogout" runat="server" Text="LogOut" ForeColor="Green" OnClick="btnLogout_Click" />
        </div>
